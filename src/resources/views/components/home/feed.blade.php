        ...
        <div style=" width: 50vh; min-width: 625px;" class="border info-feed-bot container mb-4 p-10">
            ...
            <div class="row ">
                <div class="d-flex gap-2 option-feed">
                    ...
                    @else
                        <a style="text-decoration: none" href="{{route('project.curtir', $project->id)}}"><i style="background-color: transparent" id="like-icon-{{$project->id}}" class="like-icon bi bi-heart  text-danger" title="{{$project->id}}"></i></a><div id="likes-number-{{$project->id}}" title="0" >0</div>
                        <a style="text-decoration: none" href="{{route('project.favoritar', $project->id)}}"><i style="background-color: transparent" id="favorite-icon-{{$project->id}}" class="fav-icon bi bi-bookmark text-warning" title="{{$project->id}}"></i></a><div id="favorites-number-{{$project->id}}" title="0" >0</div>
                    @endif
                </div>
            </div>
            <div class="row">
