<div>
        ...
        <button onclick="setModal('EditProfileModal')" id = "edt-btn"  class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#EditProfileModal">Editar Perfil</button>
