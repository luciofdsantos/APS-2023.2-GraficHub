...
class HomeController extends Controller
{
    ...
    {
        $projects = Project::where('user_id', '<>', auth()->id())->orderBy('created_at', 'desc')->cursorPaginate(12);
    ...
    public function personalizado()
    {
        ...
        if (auth()->check()) {
            ...
            $projects = Project::whereIn('user_id', $seguindo)->orderBy('created_at', 'desc')->cursorPaginate(12);
